                ...
                <div class="p-3 bg-body-extra-light rounded push">
                    <div class="row mb-4">
                        ...
                        <div class="col-3">
                            ...
                            <input disabled type="text" class="form-control col-sm-4"
                                   value="{{number_format($order->total - ($order->withholding_tax + $order->discount), 2)}}">
                        </div>
                        <div class="col-3">
                            <label class="text-start col-form-label">
                                ส่วนลด
                            </label>
                            <input type="text" class="form-control col-sm-4" id="discount" name="discount"
                                   value="{{ $order->discount != 0 ? $order->discount : null }}" placeholder="0.00">
                        </div>
                    </div>
